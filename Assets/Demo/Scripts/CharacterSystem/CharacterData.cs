...
namespace CreatorKitCode 
{
    ...
    public class CharacterData : HighlightableObject
    {
        ...
        {
            damageableBehaviour.Stats.Init(this);

            //Inventory.Init(this);
            Equipment = GameDataManager.instance.EquipmentData;
            Equipment.Init(this);
            Equipment.Init(weaponDefault, isEnemy);
        ...
        void Update()
        {
            damageableBehaviour.Stats.Tick();
        ...
        {
            if (target.damageableBehaviour.Stats.IsDeal())
                return false;
        ...
        public void Death()
        {
            damageableBehaviour.Stats.Death();
        }
        ...
        public void AttackTriggered()
        {
            ...
            m_AttackCoolDown = Equipment.Weapon.Stats.Speed - (damageableBehaviour.Stats.stats.agility * 0.5f * 0.001f * Equipment.Weapon.Stats.Speed);
        }
        ...
        public void Damage(int totalDamage)
        {
            ...
            if (damageableBehaviour.Stats.IsDeal()) return;
            damageableBehaviour.Stats.Damage(totalDamage);
            OnDamage?.Invoke();
        }
    }
}