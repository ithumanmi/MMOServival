...
public class AudioManager : MonoBehaviour
{
    public static AudioManager instance
    {
        get
        {
            if (ins == null)
            {
                ins = Instantiate(CoreGameManager.instance.coreGameInfo.singletonPrefabInfo.AudioManager);
    ...
    public void PlayOneSFX(AudioClip clip, Vector3 sfxPosition)
    {
        if (clip == null)
            return;
    ...
    public float GetDecibelValue(float linearValue)
    {
    ...
    public float GetLinearValue(float decibelValue)
    {
        float conversionFactor = 20f;
    ...
    public void SetVolume(string groupName, float linearValue)
    {
        AudioManager audioManager = FindObjectOfType<AudioManager>();
        if (audioManager == null)
            return;
    ...
    public void PlayDefaultTransactionSound()
    {
        AudioManager audioManager = FindObjectOfType<AudioManager>();
        if (audioManager == null)
            return;
    ...
    public void PlayDefaultWarningSound()
    {
        AudioManager audioManager = FindObjectOfType<AudioManager>();
        if (audioManager == null)
            return;
    ...
    public void PlayPotionDropSound()
    {
        AudioManager audioManager = FindObjectOfType<AudioManager>();
        if (audioManager == null)
            return;
