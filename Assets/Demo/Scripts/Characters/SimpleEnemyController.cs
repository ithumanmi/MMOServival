...
namespace CreatorKitCodeInternal {
        ...
        AnimationControllerDispatcher.IFootstepFrameReceiver
    {
        ...
        public CharacterData characterData { get { return m_CharacterData; } }
        ...
        void Update()
        {
            ...
            if(LevelManager.instance.levelState == GlobalEnum.LevelState.Out)
            {
                m_CharacterData.damageableBehaviour.Stats.ChangeHealth(-1000000);
            }
            if (m_CharacterData.damageableBehaviour.Stats.IsDeal())
            {
                ...
                EnergyManager.Instance.SpawnMultipleEnergy(transform, amountEnergy);
                characterData.damageableBehaviour.OnConfigurationDied();
                return;
            }
