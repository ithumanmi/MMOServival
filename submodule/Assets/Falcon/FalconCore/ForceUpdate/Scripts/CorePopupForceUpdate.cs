...
public class CorePopupForceUpdate : MonoBehaviour
{
    ...
    IEnumerator LoadResources()
    {
        ...
        {
            //show ok only
            ResourceRequest resourceRequest = Resources.LoadAsync<FalconPopupForceUpdate>("FalconPopupForceUpdateGame");
            yield return resourceRequest;
            if (resourceRequest == null || resourceRequest.asset == null)
            {
                // If FalconPopupForceUpdate doesn't exist, load FalconPopupForceUpdateGame
                resourceRequest = Resources.LoadAsync<FalconPopupForceUpdate>("FalconPopupForceUpdate");
                yield return resourceRequest;
            }
